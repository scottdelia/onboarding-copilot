          ...
          <>
            <div className="mb-7 max-w-3xl">
              ...
              <p className="mt-3 text-lead text-ink-muted">
                The brief asked what it would take to turn days into hours. This
                is the measurement that answers it — built before the obvious
                model, because the arithmetic is cheap and the build is not.
              </p>
            </div>
              ...
              <section className="card mt-4 overflow-hidden">
                <div className="border-b border-line px-5 py-4">
                  ...
                  <p className="mt-1 max-w-prose text-xs leading-relaxed text-ink-subtle">
                    A kill is more credible when you built the thing. Extraction
                    answers a different question from the one above — not
                    &ldquo;does it save time&rdquo; but &ldquo;can it be trusted
                    to auto-populate a carrier submission&rdquo; — and that turns
                    on <em>how</em> it fails, not how often. A null is reviewed by
                    a person; a confident wrong value posts to a carrier.
                  </p>
                </div>
                ...
                <p className="px-5 py-3.5 text-xs leading-relaxed text-ink-subtle">
                  ...
                  These are clean vector PDFs generated by the repository, so the
                  number measures transcription logic under planted hazards — a
                  leading-zero NPN beneath a watermark, a DD-MMM-YYYY date, states
                  printed in full — and not robustness to a photocopy shot on a
                  phone. Model {data.extraction.model}.
                </p>
              </section>
            )}
